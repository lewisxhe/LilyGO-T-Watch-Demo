...
#  define LV_MEM_CUSTOM_ALLOC(size)   heap_caps_malloc(size,MALLOC_CAP_SPIRAM)//malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    heap_caps_free//free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
